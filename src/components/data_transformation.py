...
# This code builds a data preprocessing pipeline that:
# Handles missing values
# Scales numerical features
# Encodes categorical features
# Combines everything into one reusable object
# This object is later used before training a machine learning model.